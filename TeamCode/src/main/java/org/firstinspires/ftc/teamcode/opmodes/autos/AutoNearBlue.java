...
public class AutoNearBlue extends AutoOpModeEx {
    ...
    private final Pose scorePose = new Pose(93.644, -43.420, Math.toRadians(43));

    private final Pose prepare1Pose = new Pose(79.249, -40.147, Math.toRadians(90));
    private final Pose intake1Pose1 = new Pose(79.249, -30.239, Math.toRadians(90));
    private final Pose intake1Pose2 = new Pose(79.249, -21.239, Math.toRadians(90));
    private final Pose intake1Pose3 = new Pose(79.249, -14.239, Math.toRadians(90));
    ...
    private final Pose intake2Pose1 = new Pose(57.764, -30.378, Math.toRadians(90));
    private final Pose intake2Pose2 = new Pose(57.764, -20.378, Math.toRadians(90));
    private final Pose intake2Pose3 = new Pose(57.764, -2.378, Math.toRadians(90));
    private final Pose prepare3Pose = new Pose(34.876, -40.730, Math.toRadians(90));
    private final Pose intake3Pose1 = new Pose(34.392, -30.932, Math.toRadians(90));
    private final Pose intake3Pose2 = new Pose(34.392, -20.932, Math.toRadians(90));
    private final Pose intake3Pose3 = new Pose(34.392, -2.932, Math.toRadians(90));
    ...
    private void buildPaths() {
        ...
        openGate = follower.pathBuilder()
                .addPath(new BezierLine(new Point(intake1Pose3), new Point(openGatePose)))
                .setLinearHeadingInterpolation(intake1Pose3.getHeading(), openGatePose.getHeading())
                .build();
    ...
    private void buildActions(){
        ...
        actions.addAll(Arrays.asList(accelerateCommand, intakeCommand, scoreCommand,
                ...
                null, null, null, null,
                null, null, scoreCommand, new WaitCommand(99999999)));
    }
