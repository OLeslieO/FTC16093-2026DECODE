...
// 我们近端，但是不拿第三组。同时，拿完第一组之后等一会再开门。等多久不知道，需要合车！

@Autonomous(name = "24005 Blue Near", group = "Competition")
public class AutoBlue24005 extends AutoOpModeEx {
...
//                .build();
        ...
        pathChainList.addPath(scorePreload, null, null, null,
                ...
                after1, null, openGate, null, score1, null,
    ...
    private void buildActions(){
        Command intakeCommand, accelerateCommand, scoreCommand, openGateCommand, waitCommand, waitForGateCommand, parkCommand;
        ...
        waitForGateCommand = new WaitCommand(8*1000).andThen(actionEnd());
        parkCommand = autoCommand.stopAll().andThen(new WaitCommand(9999999)).andThen(actionEnd());

        actions.addAll(Arrays.asList(accelerateCommand, waitCommand, intakeCommand, scoreCommand,
                null, null, null, null,
                null, waitForGateCommand, null, openGateCommand, null, scoreCommand,
                null, null, null, null,
