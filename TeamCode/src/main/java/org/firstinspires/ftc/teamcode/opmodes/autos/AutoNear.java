...
@Autonomous(name = "Auto Near", group = "Competition")
public class AutoNear extends AutoOpModeEx {
    ...
    private void buildPaths() {
        ...
        pathChainList.addPath(scorePreload, null, null,
                prepare1, intake1, after1, score1, null,
                prepare2, intake2, after2, score2, null,
                prepare3, intake3, after3, score3, null,
                null);
    }
    ...
    private void buildActions(){
        Command intakeCommand, accelerateCommand, scoreCommand;
        ...
        actions.addAll(Arrays.asList(accelerateCommand, intakeCommand, scoreCommand,
                intakeCommand, null, null, null, scoreCommand,
                intakeCommand, null, null, null, scoreCommand,
                intakeCommand, null, null, null, scoreCommand,
            ...
            if(!follower.isBusy() && !this.actionRunning){
                ...
                if(path!=null){
                    if (pathCount == 5 || pathCount == 10 || pathCount == 15){
                        follower.followPath(path,0.2,true);
                    }
